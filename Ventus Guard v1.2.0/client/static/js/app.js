...
async function loadFaceDetectionModel() {
    ...
    faceDetectionModel = new faceapi.SsdMobilenetv1Options({ minConfidence: 0.5 });
}
...
async function detectFaces(imageElement) {
    ...
    const detections = await faceapi.detectAllFaces(imageElement, faceDetectionModel);
    return detections;
}
...
function saveDetection(imageData) {
    console.log("Human detected! Saving image...");
